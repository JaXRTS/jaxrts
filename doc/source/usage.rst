...
For a full list of models currently implemented, see :doc:`models`.

From there on, we provide a extensive list of example uses in the next section
(:doc:`gen_examples/index`).
