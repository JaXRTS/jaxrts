...
* :py:class:`jaxrts.models.EdgeModel`, A model for edges, as they can be found in the bf spectrum. :py:meth:`evaluate() <jaxrts.models.EdgeModel.evaluate>` takes a third, required argument, the edge energy.
