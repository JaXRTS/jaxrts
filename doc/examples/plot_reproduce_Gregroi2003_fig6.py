...
for Z, ni, T in [(2, 0.5e23, 1), (2, 1e23, 1), (2, 5e23, 1)]:
    set_state(state, Z, ni, T)
    ax[0, 0].plot(
...
for Z, ni, T in [(2, 0.5e23, 10), (2, 1e23, 10), (2, 5e23, 10)]:
    set_state(state, Z, ni, T)
    ax[1, 0].plot(
        (setup.measured_energy - setup.energy).m_as(ureg.electron_volt),
        state.probe(setup).m_as(ureg.second),
...
for Z, ni, T in [(2, 0.5e23, 40), (2, 1e23, 40), (2, 5e23, 40)]:
    set_state(state, Z, ni, T)
    ax[2, 0].plot(
        (setup.measured_energy - setup.energy).m_as(ureg.electron_volt),
        state.probe(setup).m_as(ureg.second),
...
for Z, ni, T in [(2.0, 3e23, 1), (2.5, 3e23, 1), (3.0, 3e23, 1)]:
    set_state(state, Z, ni, T)
    ax[0, 1].plot(
        (setup.measured_energy - setup.energy).m_as(ureg.electron_volt),
        state.probe(setup).m_as(ureg.second),
    ...
    ax[0, 1].set_title(f"$n_i=$ {ni}/cm$^3$, $T=$ {T}eV")

for Z, ni, T in [(2.0, 3e23, 10), (2.5, 3e23, 10), (3.0, 3e23, 10)]:
    set_state(state, Z, ni, T)
    ax[1, 1].plot(
        (setup.measured_energy - setup.energy).m_as(ureg.electron_volt),
        state.probe(setup).m_as(ureg.second),
    ...
    ax[1, 1].set_title(f"$n_i=$ {ni}/cm$^3$, $T=$ {T}eV")

for Z, ni, T in [(2.0, 3e23, 40), (2.5, 3e23, 40), (3.0, 3e23, 40)]:
    set_state(state, Z, ni, T)
    ax[2, 1].plot(
        (setup.measured_energy - setup.energy).m_as(ureg.electron_volt),
        state.probe(setup).m_as(ureg.second),
    ...
    ax[2, 1].set_title(f"$n_i=$ {ni}/cm$^3$, $T=$ {T}eV")
